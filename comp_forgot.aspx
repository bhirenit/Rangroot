<%@ Page Language="VB" AutoEventWireup="false" CodeFile="comp_forgot.aspx.vb" Inherits="comp_forgot" %>
                            ...
                            <form id="Form1" runat="server">
                                <div class="col-md-6 animate-box" style="margin-left:400px;">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-6">
                                            <h3>Forgot Password?</h3><h6>Enter your email address,and we'll email your password to you</h6>
                                               </div>
                                        </div>
                                    <div class="row form-group">
                                        <div class="col-md-6">
                                   ...
                                   <div class="row form-group">
                                        <div class="col-md-12" style="margin-left:50px;">
                                            <asp:Button ID="submit" runat="server" CssClass="btn btn-primary" Text="Send Mail"  />
                                            <br />
                                         </div>
                                    </div>
