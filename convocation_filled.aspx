<%@ Page Language="VB" AutoEventWireup="false" CodeFile="convocation_filled.aspx.vb" Inherits="view_convo_filled" %>
                ...
                <div class="gtco-container">
                    <div class="row">
                        <div class="col-md-12" style="text-align:center;">
                            <asp:Label ID="Label1" runat="server" Text="Convocation Already Filled!!!"></asp:Label>
                            <br /><br />
