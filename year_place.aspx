<%@ Page Language="VB" AutoEventWireup="false" CodeFile="year_place.aspx.vb" Inherits="year_place" %>
                            ...
                            <div class="gtco-container">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
                                        <asp:Chart ID="year_Chart" runat="server">
                                            <Series>
                                                <%--<asp:Series></asp:Series>--%>
                                            </Series>
                                            <ChartAreas>
                                                <asp:ChartArea Name="year_ChartArea"></asp:ChartArea>
                                            </ChartAreas>
                                        </asp:Chart><br />
                                        <asp:Label ID="year" runat="server" Text=""></asp:Label>
                                        <asp:GridView ID="year_GridView" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource3" DataKeyNames="eno_no">
                                            <Columns>
                                                <asp:BoundField DataField="eno_no" HeaderText="Enrollment_no" ReadOnly="True" SortExpression="eno_no" />
                                                ...
                                                <asp:BoundField DataField="yr_of_visit" HeaderText="Year_of_visit" SortExpression="yr_of_visit" />
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [eno_no], [dept], [package], [yr_of_visit], [gender] FROM [placement_details]"></asp:SqlDataSource>
