...
Partial Class _Default
    ...
    Protected Sub submit_Click(sender As Object, e As EventArgs) Handles submit.Click
        ...
        Using con As New SqlConnection("Data Source=(LocalDB)\v11.0;AttachDbFilename=E:\Rangroot\App_Data\Database.mdf;Integrated Security=True")
            con.Open()
            Dim cmd As New SqlCommand("SELECT email_id,pswd from student_registration Where email_id= '" + email.Text + "'", con)
        ...
        Msg.Body = "Hi, Please check your Login Details Your Username: " & Convert.ToString(ds.Tables(0).Rows(0)("email_id")) & "                      Your Password: " & Convert.ToString(ds.Tables(0).Rows(0)("pswd")) & ""
