<%@ Page Language="VB" AutoEventWireup="false" CodeFile="re_place_dept.aspx.vb" Inherits="re_place_dept" %>
...
<body>
    ...
    <div id="page">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="eno_no" DataSourceID="SqlDataSource1">
            <Columns>
                ...
                <asp:BoundField DataField="comp_name" HeaderText="Company_name" SortExpression="comp_name" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [eno_no], [stud_name], [institute], [dept], [comp_name], [yr_of_visit], [package], [role] FROM [placement_details]"></asp:SqlDataSource>
