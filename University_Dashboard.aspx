<%@ Page Language="VB" AutoEventWireup="false" CodeFile="University_Dashboard.aspx.vb" Inherits="Default2" %>
...
<body>
    ...
    <div id="page">
        ...
        <div class="page-inner">
                ...
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div id="gtco-logo" style="font-size: 30px;"><a href="University_Dashboard.aspx">Convo<em>Rangroot</em></a></div>
                        </div>
                        <form id="form1" runat="server">
                            <div class="col-xs-8 text-right menu-1">

                                <ul>
                                    <li class="active"><a href="University_Dashboard.aspx">Dashboard</a></li>
                                    <li><a href="View_convo.aspx">View-Convocation-details</a></li>
                                    <li><a href="Uni_placement.aspx">Placement Details</a></li>
                                    <li>
                                        <asp:Button ID="uni_logout" Text="Logout" CssClass="btn btn-primary" runat="server" /></li>
                                </ul>
                            </div>
                        </form>
                    </div>
            ...
            <header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(images/uni_dash.jpg);">
