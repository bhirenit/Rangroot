<%@ Page Language="VB" AutoEventWireup="false" CodeFile="std_activate.aspx.vb" Inherits="std_activate" %>
    ...
    <form id="Form2" action="#" runat="server">
        ...
        <div id="page">
            ...
            <div class="page-inner">
                ...
                <header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(images/std_dash.jpg); height: 300px;">
                ...
                <div class="gtco-section border-bottom" style="margin-left: 100px; margin-right: 100px;">
                    <div class="gtco-container" style="text-align: center; color: #f54c53;">
                        <div>
                            <h1 style="font-family: 'Times New Roman'">Enter your OTP Given you through Email</h1>
                        </div>
                    </div>
                    <asp:TextBox ID="TextBox1" ValidationGroup="3" runat="server"></asp:TextBox>
                    ...
                    <asp:Button ID="Button1" ValidationGroup="3" CssClass="btn btn-primary" Style="width: 400px; height: 50px; text-align: center; margin-left: 300px;" runat="server" Text="Submit" />
