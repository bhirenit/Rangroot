...
Partial Class login_uni
	...
	Public Sub sessiongrid()
		...
		Try
            ...
            cmd.CommandText = "select * from login_uni where u_name = '" + Session("uname") + "' and pswd = '" + Session("pswd") + "'"
	...
	Protected Sub login_Click(sender As Object, e As EventArgs) Handles login.Click
        ...
        cmd = New SqlCommand("select u_name,pswd from login_uni where u_name='" + email.Text + "' and pswd = '" + pswd.Text + "'", con)
