<%@ Page Language="VB" AutoEventWireup="false" CodeFile="user_creation.aspx.vb" Inherits="user_creation" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-8 text-right menu-1">
                                <ul>
                                    ...
                                    <li class="active"><a href="create_user.aspx">Create User</a></li>
                                    <li><a href="view_employ.aspx">Employment Details</a></li>
                ...
                <div class="gtco-container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            You dont have the legal rights to create users.
