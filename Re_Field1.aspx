<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Re_Field1.aspx.vb" Inherits="Re_Field1" %>
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
                                        <asp:Chart ID="Chart3" runat="server">
                                            <Series>
                                                <%--<asp:Series Name="Series3" YValuesPerPoint="6"></asp:Series>--%>
                                            </Series>
                                            <ChartAreas>
                                        ...
                                        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="email">
                                            <Columns>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [basic_edu], [pass_month], [pass_yr], [percentage], [exp], [field], [email] FROM [emp_edu]"></asp:SqlDataSource>
