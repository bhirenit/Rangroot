<%@ Page Language="VB" AutoEventWireup="false" CodeFile="office_forgot.aspx.vb" Inherits="office_forgot" %>
                                ...
                                <div class="col-md-6 animate-box" style="margin-left:400px;">
                                   ...
                                   <div class="row form-group">
                                        <div class="col-md-12" style="margin-left:50px;">
                                            <asp:Button ID="submit" runat="server" CssClass="btn btn-primary" Text="Login"  />
                                            <br />
                                         </div>
                                    </div>
