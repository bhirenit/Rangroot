...
Partial Class _Default
    ...
    Protected Sub submit_Click(sender As Object, e As EventArgs) Handles submit.Click
        ...
        Using con As New SqlConnection("Data Source=(LocalDB)\v11.0;AttachDbFilename=E:\Rangroot\App_Data\Database.mdf;Integrated Security=True")
            con.Open()
            Dim cmd As New SqlCommand("SELECT uni_email,pswd from uni_basic Where uni_email= '" + email.Text + "'", con)
        ...
        Msg.Body = "Hi, Please check your Login Details Your Username: " & Convert.ToString(ds.Tables(0).Rows(0)("uni_email")) & "                      Your Password: " & Convert.ToString(ds.Tables(0).Rows(0)("pswd")) & ""
