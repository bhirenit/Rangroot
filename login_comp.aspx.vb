...
Partial Class login_comp
	...
	Protected Sub login_Click(sender As Object, e As EventArgs) Handles login.Click
		...
		cmd = New SqlCommand("select * from login_comp where u_name='" + email.Text + "' and pswd = '" + pswd.Text + "'", con)
	...
	Public Sub sessiongrid()
		...
		Try
			...
			cmd.CommandText = "select * from login_comp where u_name = '" + Session("uname") + "' and pswd = '" + Session("pswd") + "'"
