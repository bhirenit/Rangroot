<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Re_year1.aspx.vb" Inherits="Re_year1" %>
...
<body>
    ...
    <div id="page">
        ...
        <div class="page-inner">
            ...
            <Series>
                <%--<asp:Series Name="Series2" YValuesPerPoint="6"></asp:Series>--%>
            </Series>
            <ChartAreas>
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="email">
            <Columns>
