...
Partial Class Re_BasicEdu1
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        cmd = New SqlCommand("select DISTINCT basic_edu from emp_edu", con)
        ...
        If dt.Rows.Count <> 0 Then
            ...
            Chart5.Series("Series5").ChartType = SeriesChartType.Pie
            ...
            Do
                ...
                cmd1 = New SqlCommand("select count(*) from emp_edu where basic_edu='" + str + "'", con)
                ...
                Chart5.Series("Series5").Points.AddXY(str, cnt)
