<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Re_BasicEdu1.aspx.vb" Inherits="Re_BasicEdu1" %>
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
                                        <asp:Chart ID="Chart5" runat="server">
                                            <Series>
                                                <%--<asp:Series Name="Series5" YValuesPerPoint="6"></asp:Series>--%>
                                            </Series>
                                            <ChartAreas>
                                        ...
                                        <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="email">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="pass_month" HeaderText="pass_month" SortExpression="pass_month" />
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [basic_edu], [detail_edu], [pass_month], [pass_yr], [percentage], [field], [email] FROM [emp_edu]"></asp:SqlDataSource>
